...
def rotation_matrix_to_target_vector(vec, target_vec):
    """
    ...
    R = np.array(
        [
            [
                cos_angle + axis_x**2 * (1 - cos_angle),
            ...
            [
                ...
                cos_angle + axis_y**2 * (1 - cos_angle),
            ...
            [
                ...
                cos_angle + axis_z**2 * (1 - cos_angle),
            ],
        ]
    )
...
def calculate_collision_vector_and_jacobians(
    ...
    R = rotation_matrix_to_target_vector(distance_vec, target_z_vec)
    ...
    Jcoll1 = R @ t_frame1_to_point1.toActionMatrix()[:3, :] @ Jframe1
    ...
    Jcoll2 = R @ t_frame2_to_point2.toActionMatrix()[:3, :] @ Jframe2

    return R @ distance_vec, Jcoll1, Jcoll2
